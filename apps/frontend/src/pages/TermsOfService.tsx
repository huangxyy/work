    ...
    <div className="apple-legal-page">
      ...
      <main className="apple-legal-content">
        ...
        <section className="apple-legal-section">
          ...
          <Typography.Paragraph>
            {isZh
              ? '使用 Homework AI（以下简�?本服�?）即表示您同意受本服务条款的约束。如果您不同意这些条款，请勿使用本服务。本服务由教育机构提供，旨在为师生提供智能作业批改服务�?
        ...
        <section className="apple-legal-section">
          ...
          <ul className="apple-legal-list">
            <li>{isZh ? '手写作业图片上传与识�? : 'Handwritten homework image upload and recognition'}</li>
            <li>{isZh ? 'AI 智能批改与评�? : 'AI-powered grading and scoring'}</li>
            <li>{isZh ? '多维度作文分析与反馈' : 'Multi-dimensional essay analysis and feedback'}</li>
            <li>{isZh ? '班级作业管理与统�? : 'Class homework management and statistics'}</li>
            <li>{isZh ? '学习报告与数据导�? : 'Learning reports and data export'}</li>
          </ul>
        </section>
        ...
        <section className="apple-legal-section">
          ...
          <ul className="apple-legal-list">
            <li>{isZh ? '仅上传与学习相关的作业内�? : 'Only upload homework content related to learning'}</li>
