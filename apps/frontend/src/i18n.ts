...
const enUS: Record<string, string> = {
  ...
  'teacher.homeworkDetail.exportPrintPacket': 'Export Print Packet',
  'teacher.homeworkDetail.printPacketSplitHint': 'Large export is split into',
  'teacher.homeworkDetail.printPacketSplitUnit': 'files',
  'teacher.homeworkDetail.exportImages': 'Export Original Images ZIP',
  ...
  'teacher.batchUpload.tip1': 'Match by student account in filename or written on the image (OCR + AI).',
  'teacher.batchUpload.tip2': 'Example: student01/1.jpg or write student01 on the first page.',
...
const zhCN: Record<string, string> = {
  ...
  'teacher.homeworkDetail.exportPrintPacket': '导出批改单',
  'teacher.homeworkDetail.printPacketSplitHint': '人数较多，已自动拆分为',
  'teacher.homeworkDetail.printPacketSplitUnit': '个文件',
  'teacher.homeworkDetail.exportImages': '导出原图 ZIP',
  ...
  'teacher.batchUpload.tip1': '支持文件名匹配或图片内书写学号（OCR + AI）。',
  'teacher.batchUpload.tip2': '示例：student01/1.jpg 或在第一页写 student01。',
