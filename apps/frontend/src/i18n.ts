...
const enUS: Record<string, string> = {
  ...
  'admin.usage.successRate': 'Success Rate',
  ...
  'admin.queue.monitoring': 'Queue Monitoring',
  'admin.queue.queueStatus': 'Queue Status',
  'admin.queue.activeJobs': 'Active Jobs',
  'admin.queue.waitingJobs': 'Waiting Jobs',
  'admin.queue.successRate': 'Success Rate',
  'admin.queue.failedJobs': 'Failed Jobs',
  'admin.queue.workerHealth': 'Worker Health',
  'admin.queue.healthy': 'Healthy',
  'admin.queue.unhealthy': 'Unhealthy',
  'admin.queue.noWorkers': 'No workers available',
  'admin.queue.lastSeen': 'Last Seen',
  'admin.queue.failedAt': 'Failed At',
  'admin.queue.trendsTitle': '7-Day Queue Trends',
  ...
  'student.dashboard.welcomeTitle': 'Welcome to Homework AI!',
  'student.dashboard.welcomeDesc': 'Your homework assignments will appear here once your teacher publishes them. Click below to check for available homework.',
  'student.dashboard.viewHomeworks': 'View Homework',
  ...
  'student.homeworks.greetingMorning': 'Good morning',
  'student.homeworks.greetingAfternoon': 'Good afternoon',
  'student.homeworks.greetingEvening': 'Good evening',
  'student.homeworks.statusOngoing': 'In Progress',
  'student.homeworks.statusLate': 'Late Submission',
  'student.homeworks.statusExpired': 'Closed',
  'student.homeworks.filterAll': 'All',
  'student.homeworks.filterOngoing': 'In Progress',
  'student.homeworks.filterLate': 'Late',
  'student.homeworks.filterExpired': 'Closed',
  'student.homeworks.pendingPrefix': 'You have ',
  'student.homeworks.pendingSuffix': ' assignments to submit',
  'student.homeworks.urgent': 'Due Soon',
  'student.homeworks.deadline': 'Deadline: ',
  'student.homeworks.submitBtn': 'Submit',
  ...
  'student.report.pdfTitle': 'Student Learning Report',
  ...
  'submit.homeworkInfo': 'Homework Info',
  ...
  'teacher.dashboard.welcomeTitle': 'Welcome to Homework AI!',
  'teacher.dashboard.welcomeDesc': 'Start by creating a class and inviting your students. You can then assign homework and track their progress.',
  ...
  'teacher.reports.pdfTitle': 'Class Report',
  'teacher.reports.pdfClass': 'Class: ',
  'teacher.reports.pdfGenTime': 'Generated: ',
  'teacher.reports.pdfRange': 'Range: last ',
  'teacher.reports.pdfDays': ' days',
  ...
  'teacher.studentReport.pdfTitle': 'Student Learning Report',
  ...
  'admin.auditLogs.allLogs': 'All Logs',
  ...
  'admin.users.bulkResetConfirm': 'Reset passwords for selected users?',
  'admin.users.bulkResetDesc': 'You will be prompted to enter a new password.',
  'admin.users.bulkResetPrompt': 'Enter new password (min 6 characters):',
  'admin.users.passwordTooShort': 'Password must be at least 6 characters',
...
const zhCN: Record<string, string> = {
  ...
  'admin.queue.queueStatus': '队列状态',
  'admin.queue.activeJobs': '活跃任务',
  'admin.queue.waitingJobs': '等待任务',
  'admin.queue.successRate': '成功率',
  'admin.queue.failedJobs': '失败任务',
  'admin.queue.workerHealth': '工作节点健康',
  'admin.queue.healthy': '健康',
  'admin.queue.unhealthy': '异常',
  'admin.queue.noWorkers': '无可用工作节点',
  'admin.queue.lastSeen': '最后活跃',
  'admin.queue.failedAt': '失败时间',
  'admin.queue.trendsTitle': '7天队列趋势',
  ...
  'student.dashboard.welcomeTitle': '欢迎使用智能批改系统！',
  'student.dashboard.welcomeDesc': '老师发布作业后会显示在这里，点击下方按钮查看可用作业。',
  'student.dashboard.viewHomeworks': '查看作业',
  ...
  'student.homeworks.greetingMorning': '早上好，同学',
  'student.homeworks.greetingAfternoon': '下午好，同学',
  'student.homeworks.greetingEvening': '晚上好，同学',
  'student.homeworks.statusOngoing': '进行中',
  'student.homeworks.statusLate': '逾期补交',
  'student.homeworks.statusExpired': '已截止',
  'student.homeworks.filterAll': '全部',
  'student.homeworks.filterOngoing': '进行中',
  'student.homeworks.filterLate': '逾期',
  'student.homeworks.filterExpired': '已截止',
  'student.homeworks.pendingPrefix': '你有 ',
  'student.homeworks.pendingSuffix': ' 个作业待提交',
  'student.homeworks.urgent': '即将截止',
  'student.homeworks.deadline': '截止时间：',
  'student.homeworks.submitBtn': '提交作业',
  ...
  'student.report.pdfTitle': '得满分学习报告',
  ...
  'teacher.dashboard.welcomeTitle': '欢迎使用智能批改系统！',
  'teacher.dashboard.welcomeDesc': '开始创建班级并邀请学生加入，然后布置作业并跟踪学习进度。',
  'teacher.dashboard.createClass': '创建班级',
  ...
  'teacher.reports.pdfTitle': '得满分班级报告',
  'teacher.reports.pdfClass': '班级：',
  'teacher.reports.pdfGenTime': '生成时间：',
  'teacher.reports.pdfRange': '统计范围：近',
  'teacher.reports.pdfDays': '天',
  ...
  'teacher.studentReport.pdfTitle': '得满分学习报告',
  ...
  'admin.users.bulkResetConfirm': '确定重置已选用户的密码？',
  'admin.users.bulkResetDesc': '将提示您输入新密码。',
  'admin.users.bulkResetPrompt': '请输入新密码（至少6位）：',
  'admin.users.passwordTooShort': '密码至少需要6个字符',
  ...
  'admin.auditLogs.allLogs': '全部日志',
  'admin.auditLogs.allActions': '全部操作',
